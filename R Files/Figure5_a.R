...
pdf("/Users/tzupingliu/Desktop/Projects/Conjoin and Cabinet/Figure_New/minister_simple.pdf")
#png("/Users/tzupingliu/Desktop/Projects/Conjoin and Cabinet/Figure_New/minister.png", width=800, height=600, res=135)
ggplot(new_data[17:21,], aes(y=name, x=beta)) +  
  ...
  scale_y_discrete(limits = rev(name2[22:27])) +
